...
if __name__=='__main__':
    sorted_relation_and_entity_list_manager = Sorted_relation_and_entity_list_Management(TEST_DATA_DIR="../data/spo/valid", MODEL_OUTPUT_DIR="../output/20190326code_test", Competition_Mode=False)
