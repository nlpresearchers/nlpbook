...
if __name__=='__main__':
    sorted_relation_and_entity_list = Sorted_relation_and_entity_list_Management(TEST_DATA_DIR="../data/spo/test", MODEL_OUTPUT_DIR="../output/20190319code_test", Competition_Mode=False)
