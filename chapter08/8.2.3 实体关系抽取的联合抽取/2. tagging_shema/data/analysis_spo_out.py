...
class SPO_out_file_manager(object):
    ...
    def count_spo_list_length_according_predicate(self, reference_spo_list):
        predicate_name_list = {'所属专辑', '朝代', '连载网站', '丈夫', '创始人', '所在城市', '简称', '主演', '专业代码', '总部地点',
                               '毕业院校', '字', '号', '占地面积', '国籍', '出生地', '父亲', '祖籍', '出品公司', '上映时间', '编剧',
                               '妻子', '出版社', '官方语言', '目', '制片人', '成立日期', '歌手', '出生日期', '海拔', '人口数量',
                               '身高', '作词', '主角', '嘉宾', '作者', '修业年限', '母亲', '邮政编码', '注册资本', '民族', '主持人',
                               '董事长', '气候', '改编自', '作曲', '面积', '首都', '导演'}
