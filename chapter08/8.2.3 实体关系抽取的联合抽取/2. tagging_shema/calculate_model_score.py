...
class Sequnce_labeling_Caculate(Sequence_Labeling_and_Text_Classification_Calculate):
...
if __name__ == '__main__':
    path_to_label_file = "data/test/"

    path_to_predict_label_file = "output/epochs3_ckpt9000"
    log_out_file = path_to_predict_label_file
    intent_token_labeling_reports = Sequnce_labeling_Caculate(
